...
function setup() {
	...
	//Create a dustbin
	garbageBox = new Dustbin(width-100, height-25,100,10);
	...
	if (keyCode === UP_ARROW){
		...
		if ( paperBall.body.position.x >= width/2)
			Matter.Body.setStatic(paperBall.body,true);
				...
				Matter.Body.applyForce(paperBall.body,{x: paperBall.body.position.x, y: paperBall.body.position.y}, {x:85, y:-55});
	}
}
